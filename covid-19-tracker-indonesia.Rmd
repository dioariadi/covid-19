...
casebar <- ggplot(subset(heatmap_indo_2, data_date==max(data_date)), aes(x=total_case, y=(province), fill=total_case))+
  ...
  theme_classic()+
  scale_fill_distiller(palette="Spectral")+
  scale_x_continuous(name="Cummulative Positive Cases", breaks=c(0,1000,2000,3000,5000))+
...
### How to take graph or code in a good manner?

It's better to take a graph and make it whole without cropping it [link](https://twitter.com/jburnmurdoch/status/1244252633298341889?s=20)

![picture](plot_crop.png)
